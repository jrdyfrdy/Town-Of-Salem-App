    ...
    <div className="flex flex-col min-h-screen p-4 md:p-8 bg-gray-900 text-white gap-6">
      ...
      <div className="text-center bg-gray-800 p-4 rounded-xl shadow-lg border-2 border-gray-700 relative overflow-hidden">
        ...
        <h1 className="text-3xl font-extrabold uppercase tracking-widest relative z-10">
          {formatPhase(phase)}{" "}
          {dayCount > 0 && (
            <span className="text-gray-400 text-xl ml-2">| Day {dayCount}</span>
          )}
        </h1>
        <p
          className={`text-5xl font-mono mt-2 relative z-10 ${timeLeft <= 10 && phase !== "LOBBY" ? "text-red-500 animate-pulse" : "text-blue-400"}`}
        >
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-6">
        ...
        <div className="lg:w-1/4 bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700 h-fit">
          ...
          <div className="bg-gray-900 p-4 rounded-lg text-center shadow-inner">
            <h3 className="text-sm text-gray-400 uppercase tracking-widest mb-1">
              Your Role
            </h3>
            <p className="text-3xl text-indigo-400 font-bold mb-4">
              {me?.role || "???"}{" "}
            </p>
          </div>
          ...
          <div className="mt-4 space-y-3">
            <div className="flex justify-between bg-gray-700 p-3 rounded">
              ...
              <span
                className={`font-bold ${me?.isAlive ? "text-green-400" : "text-red-500 line-through"}`}
              >
            ...
            {players
              ...
              .map((p) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`font-semibold ${!p.isAlive ? "line-through text-gray-500" : ""}`}
                    >
